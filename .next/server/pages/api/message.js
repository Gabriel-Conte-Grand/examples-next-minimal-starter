...
/***/ "(api)/./src/pages/api/message.ts":
/*!**********************************!*\
  !*** ./src/pages/api/message.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../database */ \"(api)/./src/database/index.ts\");\n/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../models */ \"(api)/./src/models/index.ts\");\n\n\nfunction handler(req, res) {\n    switch(req.method){\n        case \"GET\":\n            return getAllMessages(req, res);\n        default:\n            return res.status(400).json({\n                message: \"Bad Request\"\n            });\n    }\n}\nconst getAllMessages = async (req, res)=>{\n    await _database__WEBPACK_IMPORTED_MODULE_0__.db.connect();\n    const allMessages = await _models__WEBPACK_IMPORTED_MODULE_1__.Message.find();\n    await _database__WEBPACK_IMPORTED_MODULE_0__.db.disconnect();\n    return res.status(200).json(JSON.parse(JSON.stringify(allMessages)));\n};\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./src/pages/api/message.ts\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./src/pages/api/message.ts"));
